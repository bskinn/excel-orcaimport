...
htmlhelp_basename = 'ORCAImporterdoc'
...
latex_documents = [
    (master_doc, 'ORCAImporter.tex', 'ORCA Importer Documentation',
     'Brian Skinn', 'manual'),
]
...
man_pages = [
    (master_doc, 'orcaimporter', 'ORCA Importer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ORCAImporter', 'ORCA Importer Documentation',
     author, 'ORCAImporter', 'One line description of project.',
     'Miscellaneous'),
]
